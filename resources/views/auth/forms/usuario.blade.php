                ...
                <form  method="POST" action="{{ route('clientes.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="form-group row">
                        <label for="dato_adjunto" class="col-md-4 col-form-label text-md-right">{{ __('Adjuntar Titulo') }}</label>
                        <div class="col-md-6">
                            <input id="dato_adjunto" type="file" class="form-control{{ $errors->has('dato_adjunto') ? ' is-invalid' : '' }}" name="dato_adjunto">
                            @if ($errors->has('dato_adjunto'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                        <label for="id_idioma" class="col-md-4 col-form-label text-md-right">{{ __('Idioma') }}</label>
                        <div class="col-md-6">
                            ...
                            @if ($errors->has('id_idioma'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('id_idioma') }}</strong>
                                </span>
                            @endif
                        </div>
                    </div>
                       ...
                       <div class="form-group row">
                        <label for="id_nivel" class="col-md-4 col-form-label text-md-right">{{ __('Nivel del manejo de Idioma') }}</label>
                        <div class="col-md-6">
